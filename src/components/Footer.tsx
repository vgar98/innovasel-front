    ...
    <>
        <footer className='bg-blue-600 text-white py-8'>
            <div className="container mx-auto text-center">
                <div className="mb-4">
                    <p> &copy; 2025 Innovasel. Todos los derechos reservados</p>
                </div>
            </div>
            ...
            <div className="flex justify-center space-x-6">
                <a href="/privacy" className="text-white">Privacidad</a>
                <a href="/terms" className="text-white">Términos de Uso</a>
            </div>
